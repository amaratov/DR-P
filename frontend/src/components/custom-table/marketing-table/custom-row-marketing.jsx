...
import { MarketingToActiveRowSlide, MarketingToArchiveRowSlide } from './custom-row-marketing-style';

function CustomMarketingRow({ row, searchText, isArchived }) {
  // dispatch
...
CustomMarketingRow.defaultProps = {
  searchText: '',
  isArchived: false,
};

export default CustomMarketingRow;
