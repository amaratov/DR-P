...
import { MARKETING_TABLE_COLUMN_CONFIG } from '../../../utils/constants/constants';
import { getSortOrderBy } from '../../../features/selectors/ui';

function SortableMarketingTableHeader(props) {
...
SortableMarketingTableHeader.propTypes = {
  onRequestSort: PropTypes.func.isRequired,
  order: PropTypes.oneOf(['asc', 'desc']).isRequired,
  isArchived: PropTypes.bool,
};

SortableMarketingTableHeader.defaultProps = {
  isArchived: false,
};

export default SortableMarketingTableHeader;
