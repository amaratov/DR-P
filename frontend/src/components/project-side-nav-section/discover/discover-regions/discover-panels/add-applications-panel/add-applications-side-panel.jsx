...
function AddApplicationsSidePanel({
  sidePanel,
  currentApplication,
  shutOffPanel,
  onApplicationClick,
  ...
  const handlePanelClose = useCallback(() => {
    ...
    setCurrentApplication({});
    onApplicationClick(currentApplication);
    shutOffPanel(false);
  }, [setAdditionalValues, setOpenHostingLocation, currentApplication, shutOffPanel, reset, onApplicationClick, setCurrentApplication]);
  ...
  const submitForm = async data => {
    const finalData = {
      named: currentApplication.iconName,
      ...
      extras: {
        ...
        iconId: currentApplication?.id || additionalValues?.id || data?.id || '',
      },
    };
    setSelectedApplicationConfig(finalData);
    setCurrentApplication({});
    setAdditionalValues({
      cloud: [],
      dataCenter: [],
  ...
  return (
    <div>
      ...
      <SwipeableDrawer
        ...
        <form onSubmit={handleSubmit(submitForm)} style={{ position: 'relative' }}>
          <Box sx={{ minWidth: 350, position: 'relative' }} role="presentation">
            <SidePanelMainWrapper>
              <SidePanelHeaderWrapper>
                <SidePanelHeaderText>{currentApplication.iconName}</SidePanelHeaderText>
                <SidePanelHeaderCloseBtn>
      ...
      <DiscoverRegionSelectionPanel
        ...
        handleCloseAddMainPanel={handleCloseAddMainPanel}
      />
    </div>
  );
}

AddApplicationsSidePanel.prototype = {
  ...
  setSelectedApplicationConfig: PropTypes.func,
  handleCloseAddMainPanel: PropTypes.func,
};

AddApplicationsSidePanel.defaultProps = {
  shutOffPanel: () => {},
  onApplicationClick: () => {},
  setCurrentApplication: () => {},
  setSelectedApplicationConfig: () => {},
...
export default AddApplicationsSidePanel;
